...
const config = {
  ...
  LOGIN_HMAC_KEY       : Buffer.from(
    'MnY3anJxejV1dW82MWRyNnFtYWk1ajlhYXFqYnY4Njk: ',
    'base64',
  ),
  LOGIN_AES_KEY     : Buffer.from('NTl3OHViamxxcG41bGRleA==', 'base64'),
  LOGIN_HMAC_LENGTH : 32,
  LOGIN_IV_LENGTH   : 16,
  LOGIN_IV_SALT     : Buffer.from(
    '+diJP/lhUh+kjtv6S1+8yrhaP+68WNOsiV2hIH+bJ8c: ',
    'base64',
  ),
  ...
  S3                   : {
    ...
    CLIENTS              : {
      client_name : {
        ...
        DOWNLOAD_DIRECTORY   :
          Argv.s3_client_name_download_directory || __dirname + '/tmp',
        httpOptions : {
          timeout : 0,
        },
        params : {
